...
{ name: "Hackathons 101 by Akshaya Dinesh", description: "Learn to make the best of your hackathon experience from Stanford student entrepreneur Akshaya Dinsesh!" },
...
{ name: "Intro to Web Development (Qoom)", description: "Intro to Web Development with Qoom" },
{ name: "AI Ethics with Ria Cherevu", description: "AI Ethics with IBM researcher Ria Cherevu" },
{ name: "Women in Tech Panel", description: "Women in Tech Panel: hear from and ask questions to women in the tech industry" },
{ name: "College Tech Leaders Panel", description: "College Tech Leaders Panel: hear from and ask questions to women studying STEM in colleeg!" },
